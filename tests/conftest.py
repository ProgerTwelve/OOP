...
@pytest.fixture             # Фикстура для проверки инициализации класса Product
def product_iphone():
    return Product("Iphone 15", "512 GB, Gray space", 210000.0, 8)


@pytest.fixture             # Фикстура для проверки инициализации класса Category
def category_phone():
...
@pytest.fixture             # Еще одна фикстура для проверки счетчиков категорий и продуктов класса Category
def category_tv():
